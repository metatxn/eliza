...
const _SupportedChainList = [
    ...Object.keys(viemChains), // Existing chains
    ...Object.keys(lensChains), // Adding lens-network chain
] as Array<keyof typeof viemChains | keyof typeof lensChains>; // Update type assertion to include new chains
